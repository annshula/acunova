  ...
  return (
    <section className="relative bg-parchment px-5 pt-16 pb-24 sm:px-8">
      <div className="mx-auto w-full max-w-md pt-6 text-center">
        ...
        {errorMessage && (
          <div className="mt-6 rounded-card border border-red-200 bg-red-50 px-5 py-4 text-left">
            <p className="text-sm text-red-700">{errorMessage}</p>
          </div>
        )}

        {!isCustomerAccountConfigured() ? (
          <div className="mt-8 rounded-card border border-line bg-ivory px-6 py-8 text-left shadow-sm">
        ...
        <div className="mt-8 flex gap-3 rounded-card border border-line bg-ivory p-4 text-left shadow-sm">
