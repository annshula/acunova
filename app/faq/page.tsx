                  ...
                  {group.items.map((f) => (
                    <StaggerItem key={f.q} as="div">
                      <details className="faq-item group">
                        <summary className="flex items-start justify-between gap-6 py-6 transition-colors duration-300 hover:text-gold">
                          <h3 className="font-display text-[1.02rem] leading-snug font-semibold tracking-[-0.02em] text-ink transition-colors duration-300 group-hover:text-gold">
                            {f.q}
                          </h3>
                          <span
                            aria-hidden
                        ...
                        <div className="faq-body">
                          <div>
                            <p
                              className="max-w-[64ch] pb-7 text-[0.9rem] leading-[1.75] text-ink-soft text-pretty [&_a]:text-gold [&_a]:underline [&_a]:underline-offset-4"
