...
export const LEGAL_PAGES: LegalPage[] = [
  ...
  },
  {
    slug: "claims-policy",
    title: "Claims Policy",
    description: "What we say about the pen, and what we deliberately don't.",
    lastUpdated: "2026-09-04",
    requiresMerchantReview: true,
    sections: [
      {
      ...
      {
        heading: "The acupressure tradition",
        body: [
          "Acupressure is the practice of applying pressure to specific points mapped in classical Chinese medicine. Those point maps have been in continuous use for a very long time and are still what every modern acupressure chart is drawn from. Many people find the points useful as part of a self-massage routine.",
          "We describe that history because it is true and it is why the product exists in this shape. We do not present it as anything more than what it is: a tradition, not a proven mechanism. Where research exists it is mixed, and we would rather say so than round it up.",
        ],
      },
      {
        heading: "What we do not claim",
        body: [
          "We do not say the pen treats, cures, prevents, or diagnoses any medical or psychological condition. We do not say it has a measurable effect on circulation, inflammation, mood, sleep, or health. Nothing we sell is a medical device, a supplement, or a therapeutic product, and nothing in our marketing should be read as such. The pen has not been evaluated or cleared by the FDA or Health Canada.",
