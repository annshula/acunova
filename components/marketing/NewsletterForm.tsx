 ...
 */
/**
 * `light` defaults to false (the dark-surface treatment) because the only
 * place this form appears is the footer, which is the one dark surface on the
 * site. It stayed a required prop while the inherited footer had a
 * light-on-/benefits branch; that branch is gone, so callers no longer have to
 * pass it.
 */
