    ...
    >
      <div className="mx-auto w-full max-w-310 px-5 py-20 sm:px-8 lg:py-28">
        ...
        <div className="mt-12 grid gap-8 lg:mt-16 lg:grid-cols-[minmax(0,19rem)_minmax(0,1fr)] lg:gap-12">
          ...
          >
            <div className="rounded-card border border-line bg-ivory p-7 shadow-(--shadow-e1)">
                      ...
                      <span className="relative h-1.5 flex-1 overflow-hidden rounded-full bg-line">
                        <span
                          className={cn(
                            ...
                            d.count > 0
                              ? "bg-linear-to-r from-gold-deep to-gold"
                              : "bg-transparent",
                          )}
              ...
              <button
                ...
                className={cn(
                  ...
                  filter === "photo"
                    ? "border-gold/50 bg-accent-soft text-ink"
...
function ReviewCard({ review }: { review: ProductReview }) {
  ...
  return (
    <li>
      <article className="h-full rounded-card border border-line bg-ivory p-5 sm:p-6">
...
function EmptyFilterState({ onReset }: { onReset: () => void }) {
  return (
    <div className="mt-4 rounded-card border border-dashed border-line-strong bg-ivory px-6 py-14 text-center">
