 ...
 * get trapped inside a transformed ancestor's stacking context (the former Tilt
    ...
    <div className="min-w-0 lg:sticky lg:top-28 lg:self-start">
      <div className="flex flex-col-reverse gap-4 lg:flex-row">
        ...
        {isVideo ? (
          ...
          >
            {/* Previously wrapped in a pointer-tracked 3D `Tilt`. That
                component is deleted: it fought the zoom affordance (the
                image moved under the cursor you were trying to click) and
                its transform created a stacking context that the zoom badge
                below had to be positioned around. A flat image that scales
                fractionally on hover reads as more precise, which suits the
                product better. */}
            <Image
              src={active.src}
              alt={active.alt}
              ...
              className="w-full transition-transform duration-500 ease-(--ease-out-soft) group-hover:scale-[1.02]"
            />
