 ...
 * ProductReviews.tsx) is used for the flagship pen and can be dropped
          ...
          <div>
            ...
            <p className="mt-6 border-t border-line pt-5 text-[0.8rem] leading-relaxed text-ink-mute">
              ...
              <a
                ...
                className="font-medium text-ink underline underline-offset-2 transition-colors hover:text-gold"
              >
