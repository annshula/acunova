...
/**
 * "The build" — a clean, easy-to-read explanation of how each item is
 * actually made. For the pen that is the body, the threaded collar and the
 * single AA cell; for the spare head set it is the four tips. Mounted on
 * every product page (id="build", targeted from the header "The build"
 * link), copy chosen to match the item.
 */
      ...
      <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-16">
        <div className="lg:sticky lg:top-32 lg:self-start">
          ...
          <Reveal
            as="p"
            delay={0.2}
            className="mt-6 border-l-2 border-gold/50 pl-5 text-[0.86rem] leading-relaxed text-ink-mute"
          >
            {content.note}
          </Reveal>
        </div>
        ...
        >
          {content.points.map((point, i) => (
            ...
            >
              <span className="grid size-10 shrink-0 place-items-center rounded-full border border-gold/25 bg-ivory text-gold">
