    ...
    <div>
      <form onSubmit={onSubmit} className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          className="inline-flex h-12.5 shrink-0 items-center justify-center rounded-full bg-linear-to-b from-gold-hot to-gold px-8 font-display text-[0.85rem] font-semibold tracking-widest whitespace-nowrap text-on-accent uppercase transition-[transform,opacity] duration-300 ease-(--ease-out-expo) hover:-translate-y-0.5 disabled:opacity-60"
        >
          ...
          {state.kind === "loading" && (
            ...
            >
              <motion.span
                ...
                className="grid size-11 place-items-center rounded-full border-2 border-line-strong border-t-gold"
              />
