...
export function DeviceIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      {/* the pen body, tip down */}
      <path
        d="M13.9 2.9 21.1 10.1 9.6 21.6l-6.2 1 1-6.2L13.9 2.9Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      {/* the collar where the head screws on */}
      <path
        d="m11.6 5.2 7.2 7.2"
        stroke="currentColor"
        strokeWidth="1.1"
        opacity=".45"
      />
      {/* the pulse leaving the tip */}
      <path
        d="M3.4 16.4 8.6 21.6"
        stroke="currentColor"
        strokeWidth="1.1"
        opacity=".45"
      />
