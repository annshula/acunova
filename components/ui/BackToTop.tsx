    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed right-4 bottom-[calc(env(safe-area-inset-bottom)+1rem)] z-40 grid size-11 place-items-center rounded-full border border-white/10 bg-ink/90 text-white shadow-(--shadow-lift) backdrop-blur-md transition-colors duration-300 hover:bg-gold hover:text-on-accent active:scale-95 sm:right-6 sm:bottom-[calc(env(safe-area-inset-bottom)+1.5rem)] sm:size-12"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
