        ...
        createPortal(
          <div className="fixed inset-0 z-85 flex items-end justify-center md:items-center md:p-6">
            ...
            <div
              ...
              aria-modal="true"
              aria-label={label}
              className="relative flex max-h-[88svh] w-full flex-col overflow-hidden rounded-t-[1.75rem] bg-ivory pb-[env(safe-area-inset-bottom)] shadow-(--shadow-lift) md:max-h-[80vh] md:max-w-3xl md:rounded-card md:pb-0"
            >
